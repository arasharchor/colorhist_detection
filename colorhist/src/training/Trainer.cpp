	...
	public:
	  ...
	  int process(const ecto::tendrils& inputs, const ecto::tendrils& outputs) 
	  {
		...
		*/
		...
		avg_color[0]=get_avg_color(color_list[skip_header_lines-14][0], avg_color[0], true, skip_header_lines-13);		
		T[0]=avg_color[0];
		avg_color[1]=get_avg_color(color_list[skip_header_lines-14][1], avg_color[1], true, skip_header_lines-13);
		T[1]=avg_color[1];
		avg_color[2]=get_avg_color(color_list[skip_header_lines-14][2], avg_color[2], true, skip_header_lines-13);
		T[2]=avg_color[2];
